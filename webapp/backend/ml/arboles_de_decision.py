...
#Funcion que crea un modelo de arbol de decision
def crear_modelo(criterio, profundidad, min_samples_split, class_weight):
...
def seleccionar_hiperparametros(X_train, y_train, X_val, y_val):
    ...
    return (mejor_criterio,mejor_profundidad,mejor_min_samples_split,mejor_class_weight,mejor_f1)
...
#Funcion principal que ejecuta el flujo del modelo de arbol de decision
def main():
    ...
    print(f"Criterion: {mejor_criterio}")
